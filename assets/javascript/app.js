var topics = ["sports", "games", "politics", "topics", "tech", "cooking", "cars", "dance", "food", "travel"];
...
function displayGifs() {
 $("button").on("click", function() {
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + gif + "&api_key=Y45DlzttKaoQZDoAnLqmXhNgDRV36MpH&limit=10";
